...
namespace Meta.Tutorial.Framework.Hub.Utilities
{
    ...
    public static class MarkdownUtils
    {
        ...
        public static string ParseMarkdown(string markdown)
        {
            ...
            // Bold
            markdown = Regex.Replace(markdown, @"(^|[^a-zA-Z0-9&])\*\*(.*?)\*\*([^a-zA-Z0-9&]|$)", "$1<b>$2</b>$3", RegexOptions.Multiline);
            markdown = Regex.Replace(markdown, @"(^|[^a-zA-Z0-9&])__(.*?)__([^a-zA-Z0-9&]|$)", "$1<b>$2</b>$3", RegexOptions.Multiline);

            // Italic
            markdown = Regex.Replace(markdown, @"(^|[^a-zA-Z0-9&])\*(.*?)\*([^a-zA-Z0-9&]|$)", "$1<i>$2</i>$3", RegexOptions.Multiline);
            markdown = Regex.Replace(markdown, @"(^|[^a-zA-Z0-9&])_(.*?)_([^a-zA-Z0-9&]|$)", "$1<i>$2</i>$3", RegexOptions.Multiline);
